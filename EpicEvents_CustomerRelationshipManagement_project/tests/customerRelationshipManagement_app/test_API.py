...
class ContractTests(APITestCase):
    ...
    def test_contract_a_support_member_can_read(self):
        ...
        # The User from SUPPORT team reads the Contract object
        response = client_support_user_B.get('/api/contracts/')
...
class EventTests(APITestCase):
    ...
    def test_event_a_sales_member_can_read(self):
        ...
        # The User from SALES team reads the Event object
        response = client_sales_user_A.get('/api/events/')
    ...
    def test_event_a_sales_member_can_update_an_event_related_to_a_contract_of_a_client_he_is_associated_with(self):
        ...
        response = client_sales_user_A.put('/api/events/{0}/'.format(tested_Event_object_id), updated_data)
    ...
    def test_event_a_sales_member_can_not_update_an_event_related_to_a_contract_of_a_client_he_is_not_associated_with(self):
        ...
        response = client_sales_user_C.put('/api/events/{0}/'.format(tested_Event_object_id), updated_data)
    ...
    def test_event_a_support_member_can_read(self):
        ...
        # The User from SALES team reads the Event object
        response = client_support_user_B.get('/api/events/')
    ...
    def test_event_a_support_member_can_update_an_event_if_he_is_the_contract_supportContact(self):
        ...
        response = client_support_user_B.put('/api/events/{0}/'.format(tested_Event_object_id), updated_data)
    ...
    def test_event_a_support_member_can_not_update_an_event_if_he_is_not_the_contract_supportContact(self):
        ...
        response = client_support_user_C.put('/api/events/{0}/'.format(tested_Event_object_id), updated_data)
    ...
    def test_event_a_support_member_can_not_delete(self):
        ...
        # The User from SALES team tries to delete the Client object
        response = client_support_user_B.delete('/api/events/{0}/'.format(tested_Event_object_id))
